...
- P5 sources use editor mode 3, P7/P8 use mode 2. A P5 base layer is NOT a valid HDR10 target (IPT-PQ-c2 colorspace) — preflight warns about missing HDR metadata/non-PQ transfer.
- Grade check thresholds live in `hybrid/grade.rs`: window fail at mean |ΔPQ| > 0.015, gate fails on ≥2 bad windows or p99 peak nits ratio > 1.5.
